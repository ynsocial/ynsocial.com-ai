...
<head>
    ...
    <title>Montoya - Creative Portfolio Template</title>
                            ...
                            <div class="inner">           
                                <ul data-breakpoint="10025" class="flexnav">
                                    <li class="link menu-timeline"><a class="active" href="#"><div class="before-span"><span data-hover="Portfolio">Portfolio</span></div></a>
                                        <ul>
                                            <li><a class="ajax-link" href="index.html" data-type="page-transition">Overlapping Gallery</a></li>
                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll1">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width height-title">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span>Folding Phone</span></h1>
                                </div>
                            </div>
                            <div id="hero-description" class="content-full-width">
                                <div class="inner">
                                    ...
                                    <hr> 
                                    <p class="has-animation">[ <a class="link-text" target="_blank" href="https://www.behance.net/gallery/173228275/01-minimal-foldable-phone-for-digital-detox"><span class="link" data-hover="View Website">View Website</span></a> ]</p>
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                        	...
                        	<!-- Row -->
                            <div class="content-row row_padding_top light-section text-align-center" data-bgcolor="#f9f9f9">
                                
                                <h1 class="has-mask-fill primary-font-title">The Carousel</h1>
                                
                                <p>
                                    <span class="has-opacity">IT IS A CLASSIC, YET YOU CAN ALWAYS </span>
                                    <br class="destroy">
                                    <span class="has-opacity">SHOWCASE STUNNING GALLERIES IN A CAROUSEL SLIDER FORMAT.</span>
                                </p>
                                ...
                                <div class="clapat-slider-wrapper content-slider looped-carousel has-animation autocenter dark-cursor">
        							<div class="clapat-slider">
                                        <div class="clapat-slider-viewport">
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/fold01.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/fold02.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/fold03.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/fold04.jpg" alt="Image Title"></div></div>
                                        </div>
                                    </div>
                            ...
                            <!-- Row -->
                            <div class="content-row small row_padding_top light-section text-align-center" data-bgcolor="#f9f9f9">
                                
                               <h1 class="has-mask-fill primary-font-title">The Options</h1>
                                
                                <p>
                                    <span class="has-opacity">CHOOSE BETWEEN LARGE OR SMALL SIZE, SELECT THE COLOR FOR THE CURSOR ON HOVER</span>
                                    <br class="destroy">
                                    <span class="has-opacity">ENABLE AUTOCENTERING ON CLICK, AND DISPLAY DOTS NAVIGATION.</span>
                                </p>
                            ...
                            <!-- Row -->
                            <div class="content-row row_padding_bottom light-section" data-bgcolor="#f9f9f9">
