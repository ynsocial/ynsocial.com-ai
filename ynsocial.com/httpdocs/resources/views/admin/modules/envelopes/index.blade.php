            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">
                        @lang('admin/components.envelopes_list')
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('admin/components.table.sender')</th>
                                <th scope="col">@lang('admin/components.table.email')</th>
                            ...
                            @foreach($module->items as $item)
                                <tr class="product-list">
                                    ...
                                    @if($item->unread)
                                        <td><span class="badge bg-info-transparent">@lang('admin/components.table.unread')</span></td>
                                    @else
                                        <td><span class="badge bg-success-transparent">@lang('admin/components.table.read')</span></td>
                                    @endif
                                    <td>
                                        <div class="hstack gap-2 fs-15">
                                            <a href="{{route("admin.".$module->type.".read",$item->id)}}" class="btn btn-icon btn-sm btn-primary3-light"><i class="ri-eye-line"></i></a>
