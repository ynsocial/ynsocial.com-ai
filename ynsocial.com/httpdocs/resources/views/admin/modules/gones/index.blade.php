            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">
                        @lang('admin/components.gones_list')
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('admin/components.table.source')</th>
                                ...
                                <th scope="col">@lang('admin/components.table.count')</th>
                            ...
                            @foreach($module->items as $item)
                                <tr class="product-list">
                                    <td class="product-checkbox"><input class="form-check-input" type="checkbox" id="product{{$item->id}}" value="{{$item->id}}"></td>
                                    <td>{{$item->id}}</td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-2">
                                                <p class="mb-0 d-flex align-items-center">
                                                    <a href="{{route("admin.".$module->type.".edit",$item->id)}}" title="@lang('admin/input.source')">
                                                        {{$item->source}}
                                                    </a>
                                                </p>
                                            </div>
