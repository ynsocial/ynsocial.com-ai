...
@section('content')
    ...
    <!-- Start::row-1 -->
    <form action="{{route("admin.".$module->type.".update", $gone->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method("put")
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            <div class="col-xl-12">
                                ...
                                <input type="text" name="source" class="form-control slug-type" id="input-source" placeholder="@lang('admin/inputs.source')" value="{{old('source') ?? $gone->source}}">
                                @error("source")
