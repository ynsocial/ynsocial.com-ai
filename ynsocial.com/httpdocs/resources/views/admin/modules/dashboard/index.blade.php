                ...
                <div class="card-body p-4">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xxl-4 col-xl-7 col-lg-7 col-md-7 col-sm-7 d-sm-block d-none text-end my-auto">
                            <img src="{{env("APP_URL")}}/admin/images/media/media-85.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table text-nowrap mb-0">
                                ...
                                <td>
                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/2.jpg" class="" alt="">
                                                        </span>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/11.jpg" class="" alt="">
                                                        </span>
                                        <div class="flex-1 ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/3.jpg" class="" alt="">
                                                        </span>
                                        <div class="flex-1 ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/21.jpg" class="" alt="">
                                                        </span>
                                        <div class="flex-1 ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/4.jpg" class="" alt="">
                                                        </span>
                                        <div class="flex-1 ms-2">
                    ...
                    <div class="d-flex align-items-start gap-3 mb-3">
                        ...
                        <div class="flex-shrink-0 text-end">
                            ...
                            <div class="avatar-list-stacked">
                                            <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/11.jpg" alt="img">
                                            </span>
                                <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/2.jpg" alt="img">
                                            </span>
                                <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/5.jpg" alt="img">
                                            </span>
                                <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/6.jpg" alt="img">
                                            </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start gap-3 mb-3">
                        ...
                        <div class="flex-shrink-0 text-end">
                            ...
                            <div class="avatar-list-stacked">
                                ...
                                <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/8.jpg" alt="img">
                                            </span>
                                <span class="avatar avatar-sm avatar-rounded">
                                                <img src="{{env("APP_URL")}}/admin/images/faces/2.jpg" alt="img">
                                            </span>
                    ...
                    <div class="d-flex align-items-start gap-3 mb-3">
                        ...
                        <div class="flex-shrink-0 text-end">
                            ...
                            <div class="avatar-list-stacked">
                                <div class="avatar-list-stacked">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{env("APP_URL")}}/admin/images/faces/15.jpg" alt="img">
                                                </span>
                                    <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{env("APP_URL")}}/admin/images/faces/3.jpg" alt="img">
                                                </span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 align-items-center">
                                        ...
                                        <div class="avatar-list-stacked ms-auto">
                                            ...
                                            <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/12.jpg" alt="img">
                                                        </span>
                                            <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/8.jpg" alt="img">
                                                        </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/4.jpg" alt="img">
                                                        </span>
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/6.jpg" alt="img">
                                                        </span>
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/7.jpg" alt="img">
                                                        </span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/16.jpg" alt="img">
                                                        </span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/14.jpg" alt="img">
                                                        </span>
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/4.jpg" alt="img">
                                                        </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{env("APP_URL")}}/admin/images/faces/21.jpg" alt="img">
                                                        </span>
                                    </div>
                                </td>
                                <td>
...
@push("scripts")
    <!-- Apex Charts JS -->
    <script src="{{env("APP_URL")}}/admin/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Projects Dashboard -->
    <script src="{{env("APP_URL")}}/admin/js/projects-dashboard.js"></script>
