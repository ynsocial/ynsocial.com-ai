                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll1">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width height-title">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span>Enclosure</span></h1>
                                </div>
                            </div>
                            <div id="hero-description" class="content-full-width">
                                <div class="inner">
                                    ...
                                    <hr> 
                                    <p class="has-animation">[ <a class="link-text" target="_blank" href="https://www.behance.net/gallery/108700595/Louqe-Ghost-S1-Personal-project"><span class="link" data-hover="View Website">View Website</span></a> ]</p>
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                        	...
                        	<!-- Row -->
                            <div class="content-row small row_padding_top light-section change-header-color text-align-center" data-bgcolor="#fff">
                                
                                <h1 class="primary-font-title has-mask-fill">Reveal Cards</h1>
                                <p>
                                    <span class="has-opacity">THIS SHORTCODE ENABLES YOU TO REVEAL MULTIPLE IMAGE INSTANCES, MAKING IT</span> 
                                    <br class="destroy"> 
                                    <span class="has-opacity">EFFORTLESS TO COMPARE THEM SIDE BY SIDE.</span>
                                </p>
                                <hr><hr>
                            ...
                            <div class="content-row light-section change-header-color text-align-center" data-bgcolor="#fff">
                                ...
                                <div class="reveal-gallery">
                                    <div class="reveal-img">
                                        <img src="images/projects/enclosure01.jpg">
                                    </div>
                                    <div class="reveal-img-fixed">
                                        <img src="images/projects/enclosure02.jpg">
                                    </div>
                                    <div class="reveal-img">
                                        <img src="images/projects/enclosure03.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="content-row small row_padding_top row_padding_bottom light-section change-header-color text-align-center" data-bgcolor="#fff">
                                ...
                                <h1 class="primary-font-title has-mask-fill">Thank you for wathing this template</h1>
                                
                                <p><span class="has-opacity">READY TO TRANSFORM YOUR DIGITAL PRESENCE?</span></p>
                                ...
                                <div class="next-project-caption text-align-center content-full-width height-title">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project01.html" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
